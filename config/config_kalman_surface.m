function Config = config_kalman_surface(ProjectDirectory)
    ...
    Config.InputLogFilename = fullfile(ProjectDirectry,'log','InputLog.mat');
    ...
    Config.OutputLogFilename = fullfile(ProjectDirectry,'log','OutputLog.mat');
